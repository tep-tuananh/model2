...
import ra.Interface.IEmployee;
import ra.utity.ConnectionDB;
...
public class Employee implements IEmployee<Employee, String> {
    ...
    public Date checkDate(Scanner scanner) {
        ...
        boolean checkOut = true;
        do {
            System.out.println("Nhập vào ngày sình: ");
